...
namespace zsdpmap
{
    class MyTile : TiledMapServiceLayer //TiledLayer
    {
        ...
        private static void SaveQueue()
        {
            ...
            while (true)
            {
                if (Buffer.Count > 0)
                {
                    ...
                    cmd.CommandText = "INSERT INTO '" + Mydata.TableName + "' (level, row, column,tile) VALUES (@Level,@Row,@Column,@Bytes)"; //,level,row,column);
        ...
        {
            //PGIS            this.FullExtent = new ESRI.ArcGIS.Client.Geometry.Envelope(111.925137105232, 9.44664648125718, 141.597475975149, 46.5533847659212)
            ...
            this.TileInfo = new TileInfo()
            {
                ...
                //PGIS                Origin = new ESRI.ArcGIS.Client.Geometry.MapPoint(0, 90)
